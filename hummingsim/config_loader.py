...
class ConfigLoader(strategy_file_path):
    ...
    def start(self):
        try:
            ...
            short_period = c_map.get("short_period").value
            medium_period = c_map.get("medium_period").value
            long_period = c_map.get("long_period").value
            ...
            self._strategy = PureMarketMakingStrategy(
                ...
                bootstrap_short_period_moving_average=bootstrap_short_period_moving_average,
                bootstrap_medium_period_moving_average=bootstrap_medium_period_moving_average,
                bootstrap_long_period_moving_average=bootstrap_long_period_moving_average,
                apply_spread_volatility_enabled=apply_spread_volatility_enabled,
                trend_spread_shift_prc=trend_spread_shift_prc,
